...
const MatchupsTab = ({ team, primaryTeamColor }) => {
  ...
  return (
    <div className="text-center py-20">
      <div className="mb-8">
        ...
        >
          <i 
            className="fas fa-sword text-3xl font-bold filter drop-shadow-sm"
        ...
        <p className="text-gray-600 text-sm max-w-md mx-auto leading-relaxed">
          {`We're working hard to bring you comprehensive matchups data for ${team.school}. Stay tuned for an amazing experience!`}
        </p>
      </div>
    </div>
  );
