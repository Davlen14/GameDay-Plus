                          ...
                          <div key={index} className="relative bg-white/30 backdrop-blur-xl rounded-xl border border-white/40 p-4">
                            ...
                            <div className="relative z-10 flex items-center justify-between">
                              <div className="flex items-center space-x-4">
                                ...
                                <div className="flex items-center space-x-3">
                                  <div 
                                    className="w-8 h-8 rounded-full bg-white/50 flex items-center justify-center overflow-hidden cursor-pointer hover:bg-white/70 transition-all duration-300"
                                    onClick={(e) => {
                                      e.stopPropagation();
                                      if (team) {
                                        localStorage.setItem('selectedTeamData', JSON.stringify(team));
